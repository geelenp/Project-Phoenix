...
| Protocol | Modbus TCP / SEMP |
| IP | 192.168.0.135 |

Status: To be configured in evcc.
...
Phoenix never communicates directly with the Home Manager.

All communication goes through evcc.
...
| pv.* | SDM120M |
| ev.* | SMA EV Charger |
| forecast.* | Solcast (future) |
| price.* | Dynamic prices (future) |
